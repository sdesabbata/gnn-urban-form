...
osmnx_dataset_val = DataLoader(osmnx_dataset_val, batch_size=32)
osmnx_loader_test = DataLoader(osmnx_dataset_test, batch_size=32)

# Define the model
gaemodel_name = "gnnuf_model_v0-12_emb8"
gaemodel_in_channels = 1
gaemodel_edge_dim = 1
gaemodel_out_channels = 8
gaemodel = GAEModel(
