...
# Torch
import torch
from torch_geometric.nn import GAE, global_mean_pool
...
leicester = ox.io.load_graphml(bulk_storage_directory + "/osmnx/raw/glasgow-1709.graphml")
...
for node in tqdm(leicester.nodes):
    # print(f"\t{node}")
...
leicester_embs_df.to_csv(this_repo_directory + "/data/glasgow-1709_emb-pool_" + model_name + ".csv", index=False)
